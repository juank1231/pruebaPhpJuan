...
<div class="container pb-6 pt-6">
    ...
    $check_usuarios=$check_usuarios->query("SELECT * FROM usuarios WHERE usuario_id='$id'");

    if($check_usuarios->rowCount()>0){
        $datos=$check_usuarios->fetch();
    ?>
	<div class="form-rest mb-6 mt-6"></div>
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjaxj" autocomplete="off" >
		...
		<div class="columns">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Email</label>
				  	<input class="input" value="<?php echo $datos['email']; ?>" type="email" name="usuario_email" maxlength="70" >
				</div>
		  	</div>
		</div>
		<br><br>
